...
# the Tensorflow 1.13.2 and onward containers uses CUDA 10.0 on Ubuntu 18.04 
CTO_BUILDALL =10.0_${STABLE_TF13}_${STABLE_OPENCV3}
CTO_BUILDALL+=10.0_${STABLE_TF13}_${STABLE_OPENCV4}
CTO_BUILDALL+=10.0_${STABLE_TF14}_${STABLE_OPENCV3}
CTO_BUILDALL+=10.0_${STABLE_TF14}_${STABLE_OPENCV4}
CTO_BUILDALL+=10.0_${STABLE_TF15}_${STABLE_OPENCV3}
CTO_BUILDALL+=10.0_${STABLE_TF15}_${STABLE_OPENCV4}

##### Tensorflow _ OpenCV
TO_BUILDALL =${STABLE_TF13}_${STABLE_OPENCV3}
TO_BUILDALL+=${STABLE_TF13}_${STABLE_OPENCV4}
TO_BUILDALL+=${STABLE_TF14}_${STABLE_OPENCV3}
TO_BUILDALL+=${STABLE_TF14}_${STABLE_OPENCV4}
TO_BUILDALL+=${STABLE_TF15}_${STABLE_OPENCV3}
TO_BUILDALL+=${STABLE_TF15}_${STABLE_OPENCV4}
